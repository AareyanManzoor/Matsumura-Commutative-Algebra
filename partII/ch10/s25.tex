...
This is bilinear and associative, and has $(1,0)$ as the unit element. Hence we get a ring structure on $C'\oplus N$. We denote this ring by $C'* N$. By the obvious definitions $\ep(a,x) = a$ and $i(x) = (0,x)$ the ring $C'*N$ becomes an extensions of $C'$ by $N$, which is called the \defemph{trivial extension}\index{trivial extension}\index{extension!trivial \indexline}.
